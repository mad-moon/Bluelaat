                                          ...
                                          <tr>
                                             <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{asset('views/host/images/facebook.png')}}" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             ...
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="{{asset('views/host/images/twitter.png')}}" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="{{asset('views/host/images/linkedin.png')}}" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                              ...
                              <tr>
                                 <td>
                                    ...
                                    <table width="140" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       <tbody>
                                          <tr>
                                             <td width="199" height="95" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="{{url()}}">
                                                      <h1 style='font-size:4em;font-family:tahoma'>{{{$title}}}</h1>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="{{asset('views/host/images/banner.png')}}" class="banner">
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                @if(isset($reasons))
                                                  سبب الرسالة: {{$reasons}} <br> <br>
                                                @endif

                                                {{$messages}}
                                                @if(isset($url))
                                                <a href='{{$url}}'>اظغط هنا<a>
                                                @endif
